...
import UnnamedChunk_2_1 from './_unnamed-chunk-2-1.png'
import UnnamedChunk_3_1 from './_unnamed-chunk-3-1.png'
import UnnamedChunk_4_1 from "./_unnamed-chunk-4-1.png"
import UnnamedChunk_5_1 from './_unnamed-chunk-5-1.png'
import UnnamedChunk_6_1 from './_unnamed-chunk-6-1.png'
import UnnamedChunk_7_1 from './_unnamed-chunk-7-1.gif'
import UnnamedChunk_8_1 from './_unnamed-chunk-8-1.gif'
import UnnamedChunk_9_1 from './_unnamed-chunk-9-1.gif'
...
dados](https://raw.githubusercontent.com/phelipetls/phelipetls.github.io/master/assets/homicides_df.csv "Link do arquivo raw") e ver que perguntas gostaríamos de responder:
...
<Image alt="Gráfico mostrando um declínio no número de homicídios na cidade de Baltimore do ano de 2007 a 2012" caption="Declínio nos homicídios nos anos de 2007-2012 em Baltimore" src={UnnamedChunk_2_1} />
...
<Image caption="A maioria das vítimas de homicídio é negra" alt="Gráfico mostrando que a maioria das vítimas de homicídio é negra" src={UnnamedChunk_3_1} />
...
<Image caption="Os homicídios tendem a aumentar ao longo dos meses" alt="Gráfico mostrando como cresceu o número de homicídios em Baltimore por mês, a cada ano, de 2007 a 2012" src={UnnamedChunk_4_1} />
...
<Image caption="Conclui-se, de cara, que a maioria das vítimas é negra e do sexo masculino" alt="Gráfico mostrando as vítimas de homicídio por recortes sociais, do que se conclui que a maioria das vítimas é negra e do sexo masculino" src={UnnamedChunk_5_1} />
...
<Image alt="Gráfico mostrando os homicídios por causa de morte, sendo por arma de fogo a mais comum, seguida de esfaqueamento" caption="Os homicídios por armas de fogo são os mais comuns" src={UnnamedChunk_6_1} />
...
<Image alt="Animação mostrando a evolução dos homicídios por localização" caption="Nota-se que a violência é concentrada em certos bairros, mas em toda a região" src={UnnamedChunk_7_1} />
...
<Image alt="Animação mostrando a evolução no tempo dos homicídios, por causa de morte" caption="Não é uma visualização interessante, porque o homicídio por arma de fogo é o mais comum em todos os anos" src={UnnamedChunk_8_1} />
...
<Image alt="Animação mostrando a evolução no tempo dos homicídios, por mês" caption="O comportamento do crescimento é consistente durante os anos" src={UnnamedChunk_9_1} />
