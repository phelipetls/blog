...
<ReactCompareSlider client:load>
  <ReactCompareSliderImage slot="itemOne" src={initialHighlighting.src} alt="There is no syntax highlight of MDX files in Neovim out of the box" />
  <ReactCompareSliderImage slot="itemTwo" src={markdownHighlighting.src} alt="After configuring Treesitter to use Markdown highlight for MDX files" />
</ReactCompareSlider>
...
Treesitter with `:InspectTree` command, making it easy to see where the
...
To test your Treesitter queries, use the command `:EditQuery` in neovim 0.10+.
...
<ReactCompareSlider client:load>
  <ReactCompareSliderImage slot="itemOne" src={markdownHighlighting.src} alt="" />
  <ReactCompareSliderImage slot="itemTwo" src={javascriptHighlighting.src} alt="" />
</ReactCompareSlider>
...
<ReactCompareSlider client:load>
  <ReactCompareSliderImage slot="itemOne" src={javascriptHighlighting.src} alt="" />
  <ReactCompareSliderImage slot="itemTwo" src={noSpellHighlighting.src} alt="" />
</ReactCompareSlider>
