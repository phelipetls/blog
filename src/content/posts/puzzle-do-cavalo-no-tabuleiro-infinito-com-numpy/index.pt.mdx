...
import KnightMoves from './_knight_moves.png'
import Histograma from './_histograma.png'
...
<Image caption="Cavalo de xadrez num plano cartesiano" alt="Um cavalo de xadrez em um tabuleiro, com setas apontando os possíveis movimentos do cavalo no xadrez e suas equivalentes coordenadas em um plano cartesiano" src={KnightMoves} />
...
<Image caption="Histograma mostrando que a probabilidade estimada do cavalo voltar à origem após 20 saltos aleatórios é de 0.6%" alt="Histograma mostrando que a probabilidade estimada do cavalo voltar à origem após 20 saltos aleatórios é de 0.6%" src={Histograma} />
