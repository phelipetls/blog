...
import GrafoDePalavras from './grafo-de-palavras.png'
import NuvemDePalavras from './nuvem-de-palavras.png'
import NuvemDePalavrasPorTemporada from './nuvem_de_palavras_por_temporada.png'
import PalavrasNegativasEPositivas from './palavras-negativas-e-positivas.png'
import SentimentoMedioAfinn from './sentimento-medio-afinn.png'
import SentimentoMedioBing from './sentimento-medio-bing.png'
import SentimentoMedioNrc from './sentimento-medio-nrc.png'
...
<Image title="Grafo das palavras mais comuns em Game of Thrones" alt="Grafo das palavras mais comuns em Game of Thrones" src={GrafoDePalavras} />
...
<Image title="Nuvem de palavras das palavras mais comuns em Game of Thrones" alt="Nuvem de palavras das palavras mais comuns em Game of Thrones" src={NuvemDePalavras} />
...
<Image title="Nuvem de palavras por temporada" alt="Nuvem de palavras por temporada" src={NuvemDePalavrasPorTemporada} />
...
<Image title="Palavras negativas e positivas" alt="Palavras negativas e positivas" src={PalavrasNegativasEPositivas} />
...
<Image title="Sentimento médio, método afinn" alt="Sentimento médio, método afinn" src={SentimentoMedioAfinn} />
...
<Image title="Sentimento médio, método bing" alt="Sentimento médio, método bing" src={SentimentoMedioBing} />
...
<Image title="Sentimento médio, método NRC" alt="Sentimento médio, método NRC" src={SentimentoMedioNrc} />
