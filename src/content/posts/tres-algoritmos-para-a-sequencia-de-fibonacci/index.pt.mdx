...
<Image title="Uma ilustração do algoritmo recursivo para a sequência de Fibonacci" src={Fibonacci} />
...
<Image alt="Animação de como funcionam os Eigenvectors, mostrando que eles não mudam de direção mesmo após uma transformação matricial" title="Ilustração de como funcionam os Eigenvectors" src={EigenVectors} />
