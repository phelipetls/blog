...
type Props = SandpackProps & { debounceCode: string }

export default function DebounceReactUseCallbackExample(props: Props) {
  return (
    <Sandpack
      {...props}
      title='Implementing debounced event handler in React with useCallback'
      template='react'
      files={{
