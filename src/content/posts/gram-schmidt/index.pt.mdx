...
import ProjecaoVetorial from './projecao-vetorial.png'
import Vetores from './vetores.png'
...
<Image alt="Vetores na terceira dimensão" title="Vetores na terceira dimensão" src={Vetores} />
...
<Image title="Projeção vetorial" alt="Projeção do vetor a1 sobre o vetor a2" src={ProjecaoVetorial} />
